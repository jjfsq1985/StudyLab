...
{
  return "application/npruntime-publishcardx-plugin:Scriptability PublishCardX Plugin";
}
...
NPError	NPP_GetValue(NPP instance, NPPVariable variable, void *value)
{
  ...
  case NPPVpluginNameString:
    *((char **)value) = "NPPublishCardX";
    break;
  case NPPVpluginDescriptionString:
    *((char **)value) = "NPRuntime Scriptability PublishCardX Plugin";
    break;
