#ifndef LIB_EVENT_HANDLER
#define LIB_EVENT_HANDLER

#include "event_loop.hpp"

/** \file
 * \brief Declares the \ref lib::event_handler "event_handler" class.
 */
namespace lib {
...
\code
	...
	typedef lib::simple_event<foo_event_type, int, std::string> foo_event;

	struct bar_event_type{};
	typedef lib::simple_event<bar_event_type> bar_event;

	class my_handler final : public lib::event_handler
	{
	public:
		my_handler(lib::event_loop& loop)
			: lib::event_handler(loop)
		{}
		...
		virtual void operator()(event_base const& ev) {
			...
			lib::dispatch<foo_event, bar_event>(ev, this, &my_handler::foo, &my_handler::bar);
		}
	};
...
\endcode
*/
class LIB_PUBLIC_SYMBOL event_handler
{
public:
