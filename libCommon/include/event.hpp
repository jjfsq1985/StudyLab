#ifndef LIB_EVENT_HEADER
#define LIB_EVENT_HEADER
...
*/
class LIB_PUBLIC_SYMBOL event_base
{
public:
	event_base() = default;
	virtual ~event_base() {}
	...
	done in \ref lib::simple_event "simple_event".
	*/
...
EXPORT_TEMPLATE template class LIB_PUBLIC_SYMBOL simple_event<timer_event_type, timer_id>;
