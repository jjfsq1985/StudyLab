#ifndef LIB_IPUTILS_HEADER
#define LIB_IPUTILS_HEADER
 ...
 */
std::string LIB_PUBLIC_SYMBOL get_ipv6_long_form(std::string const& short_address);
std::wstring LIB_PUBLIC_SYMBOL get_ipv6_long_form(std::wstring const& short_address);
 ...
 */
bool LIB_PUBLIC_SYMBOL is_routable_address(std::string const& address);
bool LIB_PUBLIC_SYMBOL is_routable_address(std::wstring const& address);
...
address_type LIB_PUBLIC_SYMBOL get_address_type(std::string const& address);
address_type LIB_PUBLIC_SYMBOL get_address_type(std::wstring const& address);
