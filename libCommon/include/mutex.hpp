#ifndef LIB_MUTEX_HEADER
#define LIB_MUTEX_HEADER
 ...
 */
class LIB_PUBLIC_SYMBOL mutex final
{
public:
 ...
 * counting.
 */
class LIB_PUBLIC_SYMBOL scoped_lock final
{
public:
 ...
 */
class LIB_PUBLIC_SYMBOL condition final
{
public:
	condition();
	~condition();
